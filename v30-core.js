(() => {
  ...
  window.SohbetixV30={
    ...
    deletedNicks,reserveDeletedNick,nickAvailable,ignored,ignoreNick,unignoreNick,isIgnored,ownerIdForNick,ignoredBy,isBlockedBetween,allPresence,isNickOnline,removeNickFromAllPresence,ageFromBirth
  };
})();
